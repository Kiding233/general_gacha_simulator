...
class SimulationThread(QThread):
    ...
    def run(self):
        try:
            ...
            target_specs = {tc.card_id: tc.quantity for tc in self.config_store.target_cards}
            ...
            strategy_key = strategy_type_to_key(self.config_store.strategy_type)
...
class GachaPanel(QWidget):
    ...
    def start_simulation(self):
        ...
        from ..core.strategy import strategy_type_to_key, STRATEGY_REGISTRY
        _skey = strategy_type_to_key(self._store.strategy_type)
        self._strategy_key = _skey
        sname = STRATEGY_REGISTRY.get(_skey, {}).get('display_name', _skey)
