...
class AboutDialog(QDialog):
    ...
    def _create_about_tab(self):
        ...
        <ul>
            ...
            <li><b>策略系统</b>：智能策略、配额策略、保底预留策略、目标停止策略</li>
            <li><b>广义出率（GDR）</b>：9 种可配置的广义出率指标</li>
...
[3]=r</pre>
    ...
    def _create_algorithms_tab(self):
        ...
        <h4>广义出率（GDR）计算</h4>
        <p>支持 10 种 GDR 指标，从 compact 模拟结果中计算：</p>
        <ul>
            ...
            <li><b>专武角色比</b>：已抽角色对应的专武数 / 已抽角色数（需要角色-武器对应表配置，当前未实现配置入口）</li>
        </ul>
